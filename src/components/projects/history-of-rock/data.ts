...
export const GENRES: Genre[] = [
  ...
  { id: 'rockabilly', label: 'ROCK A BILLY', artists: ['Carl Perkins', 'Gene Vincent', 'Elvis', 'Everly Brothers', 'Buddy Holly', 'Roy Orbison', 'Eddie Cochran'], x: -380, y: -50 },

  // Second wave
  { id: 'folk-rock', label: 'FOLK ROCK', artists: ['Van Morrison', 'Dave Mason', 'Creedence Clearwater Revival', 'Jackson Browne', 'Simon & Garfunkel', 'The Band'], x: -100, y: -350 },
  ...
  { id: 'unclassifiable', label: '?', artists: ['Zappa', 'Can', 'Capt. Beefheart'], x: 400, y: 280 },
  { id: 'rap', label: 'RAP', artists: ['Dr. Dre', 'The Geto Boys', 'Public Enemy', 'N.W.A.', 'LL Cool J', 'Run DMC'], x: 250, y: 350 },
  ...
  { id: 'heavy-metal', label: 'HEAVY METAL', artists: ['Motorhead', 'Black Sabbath', 'Dio', 'Judas Priest', 'Iron Maiden', 'Metallica'], x: 550, y: -250 },
...
export const CONNECTIONS: Connection[] = [
  ...
  // Early branches
  { source: 'folk', target: 'folk-rock' },
  { source: 'folk', target: 'brit-invasion', bridgeArtist: 'Bob Dylan' },
  { source: 'r-and-b', target: 'doo-wop' },
  { source: 'r-and-b', target: 'soul' },
  { source: 'rockabilly', target: 'brit-invasion' },

  // Middle flows
  { source: 'brit-invasion', target: 'pop-rock' },
  { source: 'brit-invasion', target: 'psychedelic-rock', bridgeArtist: 'Jimi Hendrix' },
  { source: 'soul', target: 'psychedelic-rock' },
  { source: 'soul', target: 'funk' },
  ...
  { source: 'hard-rock', target: 'heavy-metal' },
  { source: 'hard-rock', target: 'punk' },
  { source: 'prog-rock', target: 'glitter-glam' },
  { source: 'glitter-glam', target: 'unclassifiable' },

  // Funk/Disco/Rap flow
  { source: 'funk', target: 'disco' },
  { source: 'disco', target: 'rap' },
  { source: 'rap', target: 'hip-hop' },
